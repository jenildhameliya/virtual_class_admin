      ...
      <div class="content-header">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
            <a href="{{ route('class_create') }}" class="btn btn-info"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add Class</a>
            </ol>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Class</td>  
                      <td>
                        <a href="{{ route('class_edit') }}" class="btn btn-success">Edit</a>
